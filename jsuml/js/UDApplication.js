...
Application.prototype._generateGeneralMenu = function() {
  ...
  this._addMenuItem(this._tools_ul1, "Exportar/Importar de XML", function(m) {
    var p = this;
    this._active = true;
    var h = document.createElement("div");
...
_acceptedElementsUML.push(["Class", "UMLClass"], ["Data Type", "UMLDataType"], ["Association N-ary", "UMLNAssociation"], ["Component (Class diagram)", "UMLComponent"], ["Interface Extended", "UMLInterfaceExtended"], ["UMLPackage", "Package"], ["Package Container", "UMLPackageContainer"], ["Generalization Set", "UMLGeneralizationSet"]);
...
_acceptedElementsUML.push(["Component (Component diagram)", "UMLComComponent"], ["Interface", "UMLInterface"]);
