...
\titulo{Proposta Web para Prática de Algoritmos com acesso Offline}
...
\hypersetup{
		...
		pdftitle={\@title},
		pdfauthor={\@author},
    	pdfsubject={Protótipo de Aplicação para Prática de Algoritmos via \textit{Web} com acesso \textit{Offline}},
