...
%\begin{table}[h]
%\centering
%  \caption{Suporte \textit{offline} via \textit{AppCache}}\label{tab:appcache-compatibility}
%\begin{tabular}{ c{0.1\textwidth} | c{0.1\textwidth} | c{0.1\textwidth} | c{0.1\textwidth} | c{0.1\textwidth} | c{0.1\textwidth} | c{0.1\textwidth} }\hline
%IE & Firefox & Safari & Chrome & Opera & iPhone & Android \\ \hline
% & 3.5+ & 4.0+ & 5.0+ & 10.6+ & 2.1+ & 2.0+ \\ \hline
%\end{tabular}
%  \caption*{\ifdraft{\color{green}}{}\footnotesize Fonte: \citeonline{diveintohtml5}.}
%\end{table}
