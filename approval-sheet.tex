...
\begin{folhadeaprovacao}
  ...
  \begin{description}[labelindent=0pt,labelwidth=4cm] %label={\textnormal},
    \item[Orientador:]
    \assinaturaorientador{\textbf{\imprimirorientador \\ Universidade do Vale do Itajaí}}
  \end{description}
  ...
  \begin{description}[labelindent=0pt,labelwidth=4cm] %label={\textnormal},
    \item[Membros:]
    \vspace*{\ABNTEXsignskip}
    \assinaturaorientador{\textbf{(titulação + nome completo) \\ IES de origem}}
    \item[]
    \vspace*{\ABNTEXsignskip}
    \assinaturaorientador{\textbf{(titulação + nome completo) \\ IES de origem}}
  \end{description}
   ...
   \begin{center}
    \vspace*{0.5cm}
    \inserecidade~\insereuf, 24/11/2016
    \vspace*{1cm}
  \end{center}
