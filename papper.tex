...
% Folha de Aprovação
% TODO PRINT Descomentar
%\input{pretextuals/approval-sheet.tex}

% Dedicatória, Agradecimentos, Epígrafe - Elementos Pré textuais opcionais
% TODO PRINT Descomentar
%\input{pretextuals/optionals/pretextuals-optionals.tex}

% Resumos (em português e pelo menos em inglês)
% TODO PRINT Descomentar
%\input{pretextuals/abstracts.tex}

% Lista de Ilustrações
% TODO PRINT Descomentar
%\input{lists/figures-list.tex}

% Lista de Siglas
% TODO PRINT Descomentar
%\input{lists/tables-list.tex}

% Lista de Siglas
% TODO PRINT Descomentar
%\input{lists/acronyms-list.tex}
...
\input{chapters/chapter2-old.tex}
